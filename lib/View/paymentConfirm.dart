...
import 'package:Khaldiya/View/screan_DoneOrder.dart';
import 'package:flutter/material.dart';
import '../View/ToolsApp/WidgetApp.dart';
import '../View/ToolsApp/StyleApp.dart';
import '../View/ToolsApp/myTextField_Outline.dart';
    ...
    return Directionality(textDirection: TextDirection.rtl,
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: Text(""),
          actions: <Widget>[
            IconButton(icon: Icon(Icons.arrow_forward_ios,color: anBlack),
          ...
          child: ListView(
            ...
            children: [
              ...
              new RadioListTile(
                dense: true,
                activeColor: anGreen,
                title: Text("كي نت",style: TextStyle(fontSize:fontsize, height: 1),),
                value: 0,
              ...
              new RadioListTile(
                dense: true,
                activeColor: anGreen,
                title: Text("الدفع عن الاستلام",style: TextStyle(fontSize:fontsize,height: 1),),
                value: 1,
                groupValue: selectedRadio,
                onChanged: (val) {
                  setState(() {
              ...
              my_Button(
                ...
                onTap: (){
                  ...
                  if(_payment == "كي نت"){
                    ...
                    return Navigator.push(context, MaterialPageRoute(builder: (context) => screan_DoneOrder(),));
                  }
                },
              ),
